        ...
        <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:items-start">
          <div>
            <SectionHeading
              ...
              highlight=""
              description="Drop a photo below. Subject stays clear, only background gets blurred."
            />
            ...
            <div className="mt-6 flex flex-wrap items-center gap-3">
              <span className="inline-flex items-center gap-2 rounded-full border border-brand-secondary/20 bg-brand-secondary/5 px-4 py-2 text-sm font-semibold text-brand-secondary">
                ...
                ~2 to 3 seconds processing time
              </span>
            ...
            <div className="mt-6 rounded-2xl border border-brand-border bg-white/80 p-4">
              ...
              <div className="mt-3 flex items-center gap-4">
                ...
                />
                <span className="w-12 text-right text-sm font-semibold text-brand-text">{intensity}</span>
                <span className="hidden items-center gap-2 text-xs text-brand-muted sm:flex">
                      ...
                      <motion.div key="uploaded" initial={{ opacity: 0, scale: 0.98 }} animate={{ opacity: 1, scale: 1 }} className="flex flex-col items-center gap-5 py-4 sm:flex-row sm:items-start">
                        ...
                        <div className="flex-1 text-center sm:text-left">
                          <span className="inline-flex items-center gap-2 rounded-full border border-emerald-200 bg-emerald-50 px-4 py-2 text-sm font-medium text-emerald-700">
                            ...
                            Blur complete — see results below
                          </span>
                          {fileInfo && <p className="mt-3 text-sm text-gray-500">{fileInfo.name} · {formatBytes(fileInfo.size)} · intensity {intensity}</p>}
