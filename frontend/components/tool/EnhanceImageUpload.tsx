        ...
        <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:items-start">
          <div>
            <SectionHeading
              ...
              highlight=""
              description="Run advanced enhancement with AI clarity recovery, denoise cleanup, and controlled sharpening."
            />
            ...
            <div className="mt-6 flex flex-wrap items-center gap-3">
              <span className="inline-flex items-center gap-2 rounded-full border border-brand-secondary/20 bg-brand-secondary/5 px-4 py-2 text-sm font-semibold text-brand-secondary">
                ...
                ~5 to 40 seconds · Professional enhancement
              </span>
            ...
            <div className="mt-6 grid gap-4 rounded-2xl border border-brand-border bg-white/80 p-4 sm:grid-cols-2">
              <div>
                <p className="text-xs font-bold uppercase tracking-wider text-brand-muted">Sharpen</p>
                <div className="mt-2 flex items-center gap-4">
                  <input type="range" min={0} max={100} value={sharpen} disabled={uploadLocked} onChange={(e) => setSharpen(Number(e.target.value))} className="w-full accent-brand-purple" aria-label="Sharpen" />
                  <span className="w-10 text-right text-sm font-semibold text-brand-text">{sharpen}</span>
                </div>
              </div>
              <div>
                      ...
                      <motion.div key="uploaded" initial={{ opacity: 0, scale: 0.98 }} animate={{ opacity: 1, scale: 1 }} className="flex flex-col items-center gap-5 py-4 sm:flex-row sm:items-start">
                        ...
                        <div className="flex-1 text-center sm:text-left">
                          <span className="inline-flex items-center gap-2 rounded-full border border-emerald-200 bg-emerald-50 px-4 py-2 text-sm font-medium text-emerald-700">
                            ...
                            Enhancement complete — see results below
                          </span>
                          {fileInfo && <p className="mt-3 text-sm text-gray-500">{fileInfo.name} · {formatBytes(fileInfo.size)} · sharpen {sharpen} · denoise {denoise}</p>}
