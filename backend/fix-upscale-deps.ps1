# Fix upscale + opencv / segmentation deps (run once from backend folder)
...
& $py -m pip install "numpy==1.26.4" "opencv-python-headless==4.9.0.80" "pymatting>=1.1.0" "rembg==2.0.59"
